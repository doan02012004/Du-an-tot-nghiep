...
import { loginFailed, loginStart, loginSuccess, registerFailed, registerStart, registerSuccess } from "./../redux/features/authSlice";
import { Isignin, Isignup, Iuser } from "./../interfaces/auth";
