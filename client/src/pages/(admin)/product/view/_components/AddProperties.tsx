  ...
  return (
    <div className='mb-4'>
        ...
        <div className='flex items-center gap-x-4'>
            <Button onClick={()=>{setOption('size')}} className='text-white bg-indigo'>Thêm size</Button>
            <Button onClick={()=>{setOption('color')}} className='text-white bg-indigo'>Thêm màu</Button>
        </div>
    </div>
  )
}
