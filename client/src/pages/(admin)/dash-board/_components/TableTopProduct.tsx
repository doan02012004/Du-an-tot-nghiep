      ...
      return (
        <div className="col-span-full xl:col-span-6 bg-white dark:bg-gray-800 p-3 shadow-lg shadow-gray-300 rounded-lg">
          <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            <h2 className="font-semibold text-gray-800 dark:text-gray-100">Sản phẩm được mua nhiều nhất</h2>
          </header>      
          <div className="p-3">
                        ...
                        <tr key={customer?._id}>
                          <td className="p-2 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0 mr-2 sm:mr-3">
                                <img className="object-cover w-full" src={customer?.productInfo?.gallerys[0]?.avatar} alt={customer?.productInfo?.name} />
                              </div>
