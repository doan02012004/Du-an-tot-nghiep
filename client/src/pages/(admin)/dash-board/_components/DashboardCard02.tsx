...
const DashboardCard02 = () => {
    ...
    const revenceQuery = useOrderStatusCountQuery({startDate:startDate,endDate:finishDate,status:"pending"})
   useEffect(()=>{
      ...
      <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-800 shadow-sm shadow-gray-500 rounded-xl">
        <div className="p-5">
          <header className="flex justify-between items-start mb-2">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Đơn hàng mới</h2>
          </header>
          {/* <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Sales</div> */}
          <div className="flex items-start">
            <div className="text-xl font-bold text-gray-800 dark:text-gray-100 mr-2">{total}</div>
