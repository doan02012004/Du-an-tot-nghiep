...
function DashboardCard01() {
  ...
  const revenceQuery = useRevenueQuery({startDate:startDate,endDate:finishDate})
 useEffect(()=>{
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-gray-800 shadow-sm shadow-gray-500 rounded-xl">
      <div className="p-5">
        ...
        <div className="flex items-start">
          <div className="text-xl font-bold text-gray-800 dark:text-gray-100 mr-2">{formatPrice(total)}đ</div>
