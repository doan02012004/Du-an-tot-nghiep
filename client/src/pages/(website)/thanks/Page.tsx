  ...
  <div className="container mx-auto">
    <div className="flex flex-col items-center py-10 lg:px-72 gap-4">
      ...
      <div className="flex items-center justify-between gap-4">
        <Link to="/" className=""><button className="text-sm px-3 py-2 lg:text-base lg:w-[240px] border border-black bg-black text-white  lg:px-5 lg:py-3 rounded-tl-[20px] rounded-br-[20px] hover:bg-white hover:text-black hover:border hover:border-black">TIẾP TỤC MUA SẮM</button></Link>
