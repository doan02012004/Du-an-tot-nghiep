...
const AddressList = () => {
  ...
  return (
    <div className="w-full">
        {/* Header start  */}
        <div className="flex justify-between items-center pb-3 border-b border-b-gray-200 mb-3">
            <h2 className="text-xl  font-semibold text-black lg:text-2xl">Sổ địa chỉ</h2>
            <button onClick={()=>{setIsOpenForm(true)}} className="px-4 py-2 btn-sm border text-white bg-dark hover:text-black hover:bg-white font-medium"><PlusCircleFilled /> Thêm địa chỉ </button>
           {isOpenForm && (
