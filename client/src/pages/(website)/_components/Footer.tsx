...
const Footer = () => {
  const onHandleInfor = (index: number) => {
    const footer_contents = document.querySelectorAll<HTMLElement>(
      ".footer-infomation-content"
    );
    const footer_icons = document.querySelectorAll<HTMLElement>(
      ".footer-infomation-icon "
    );
      ...
      <div className="container">
        <div className="flex flex-col w-full pt-[23px] pb-8 border-b border-gray-200 lg:pt-[60px]  lg:justify-between lg:flex-row ">
          <div className="order-3 lg:max-w-[22.05%] w-full lg:order-1">
            ...
            <a
              href="#"
              className="block text-base text-white uppercase font-semibold px-6 py-3 border border-[#221F20] rounded-tl-lg rounded-br-lg bg-[#221F20] transition duration-300 ease-in-out text-center hover:text-black hover:bg-white "
            >
          ...
          <div className="order-2 mb-4  w-full flex flex-col lg:justify-between lg:flex-row lg:max-w-[45.2%] lg:mb-0 lg:order-2">
            <div>
              <div
                onClick={() => onHandleInfor(0)}
                className="footer-information cursor-pointer flex justify-between lg:justify-normal lg:cursor-auto "
              >
                <h3 className="text-dark text-base mb-[14px] font-semibold lg:mb-5 lg:text-2xl">
                  Giới thiệu
                </h3>
                <span className="footer-infomation-icon lg:hidden">
          ...
          <div className=" order-1 lg:max-w-[23.75%] w-full mb-8 lg:order-3">
            <div className="w-full px-4 py-6 border-[4px] rounded-tl-[56px] rounded-br-[56px] ">
              <h3 className="text-xl text-dark max-w-[80%] mb-2 font-semibold ">
                Nhận thông tin các chương trình của Fendi Shop
              </h3>
              <form className="flex border-b border-gray-200 rounded-br-3xl">
                <input
                  type="text"
                  placeholder="Nhập địa chỉ email"
                  className="w-full text-sm pb-3 pr-[10px] outline-0 border-0"
                />
                <button
                  type="submit"
                  className="flex-shrink-0 py-3 px-[27px] rounded-tl-3xl rounded-br-3xl text-base border border-gray-900 transition duration-300 ease-in-out hover:bg-dark hover:text-white"
                >
                  Đăng ký
                </button>
              </form>
