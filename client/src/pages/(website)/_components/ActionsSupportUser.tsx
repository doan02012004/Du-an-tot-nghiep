    ...
    return (
        <>
            <div className="relative hidden lg:block">
                <span onClick={onHandeActionSupport} className="block text-base cursor-pointer sub-top hover:text-gray-800">
            ...
            <div className="relative hidden lg:block">
                {accessToken ? (
                    <span onClick={onHandeActionUser} className="block text-base cursor-pointer sub-top hover:text-gray-800">
                        <i className="fa-regular fa-user" />
                    </span>
                ) : (
                    <a href="/signin" className="block text-base cursor-pointer sub-top hover:text-gray-800">
                        <i className="fa-regular fa-user" />
                    </a>
                )}
