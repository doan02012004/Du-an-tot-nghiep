...
const CartPage = () => {
    ...
    useEffect(() => {
        if (carts.length > 0) {
            ...
            if(check || checkAtb || checkUndefine| checkInstock||checkProduct| checkQuantity){
                if(checkCarts == true){
                ...
                <div className="container pb-4 mx-auto lg:flex pt-11 lg:gap-10">
                    <div className="lg:w-[68%]">
                        ...
                        <div className="py-6 lg:pt-7">
                            <a href="/" className="w-[60%] flex items-center border border-black lg:w-[30%] py-3 justify-center gap-2 rounded-tl-[20px] rounded-br-[20px] hover:bg-black hover:text-white">
