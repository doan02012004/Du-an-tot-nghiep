        ...
        <div className="bg-[#FBFBFC]">
            <div className="px-5 pt-4 pb-8 flex flex-col gap-4">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm">{cartUser?.totalCart}</span>
                </div>
                <div className="flex justify-between items-center">
                    <span className="text-sm">Tổng tiền hàng</span>
                    <span className="text-sm">{cartUser ?formatPrice(cartUser?.totalPrice):"0"}đ</span>
                </div>
                <div className="flex justify-between items-center">
                    <span className="text-sm">Thành tiền</span>
                    <span className="text-lg text-dark font-semibold">{cartUser ?formatPrice(cartUser?.totalPrice):"0"}đ</span>
                </div>
